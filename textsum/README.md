...
./data:
vocab  test-0  training-0  training-1  validation-0 ...( buoomitted)
...
```
 ...
 python data_convert.py --command text_to_binary --in_file /home/lily/projects/textsummarization/data/segmentation.news_tensite_xml.smarty.dat --out_file /home/lily/projects/textsummarization/data/data1
